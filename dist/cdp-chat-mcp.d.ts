...
import { CdpChatClient, type CdpChatCapabilities, type CdpChatDriver } from "./cdp-chat.js";
/** Register all standalone CDP website chat tools on one MCP server. */
export declare function registerCdpChatTools(server: McpServer, client: CdpChatClient, capabilities?: CdpChatCapabilities): void;
